...
#
# Generated by export_simulation on Fri Jul 19 16:20:03 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './hdmi_axi_dynclk_0_0.sh' script.

./hdmi_axi_dynclk_0_0.sh -reset_run
...
./hdmi_axi_dynclk_0_0.sh -noclean_files

For more information on the script, please type './hdmi_axi_dynclk_0_0.sh -help'.
